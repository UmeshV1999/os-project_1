...
void main()						//a_t=arrival time,b_t,Burst time,c_t=Completion time,w_t=waiting time
{								//L=Limit, C=Count
								//t_t= turn around time,a_w_t=average waiting time,a_t_t=average turnaround time
	struct process temp;
